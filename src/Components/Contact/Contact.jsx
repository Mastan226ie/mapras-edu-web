...
const Contact = () => {
    ...
    const access_key = import.meta.env.VITE_WEB3_CONTACT_KEY;
  ...
  return (
    <div className='contact'>
        <div className='contact-col'>
            ...
            <ul>
                <li><img src={mail_icon} alt="" />Contact@mapra.dev</li>
                <li><img src={phone_icon} alt="" />+1 123-456-19</li>
                <li><img src={location_icon} alt="" />19 Sky Tower, Tokyo <br /> 02619 , Japan</li>
            </ul>
        </div>
        <div className="contact-col">
